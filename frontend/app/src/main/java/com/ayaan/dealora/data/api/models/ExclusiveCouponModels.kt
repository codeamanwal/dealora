...
data class ExclusiveCouponListResponseData(
    ...
    @Json(name = "coupons") val coupons: List<ExclusiveCoupon>
)
...
data class ExclusiveCoupon(
    ...
    @Json(name = "stackable") val stackable: String? = null,
...
data class ExclusiveCouponDetailResponseData(
    @Json(name = "coupon") val coupon: ExclusiveCoupon
)
...
data class ExclusiveCouponStatsResponseData(
    ...
    @Json(name = "expired") val expired: Int,

    @Json(name = "expiringSoon") val expiringSoon: Int,

    @Json(name = "byCategory") val byCategory: Map<String, Int>,

    @Json(name = "bySource") val bySource: Map<String, Int>
)
